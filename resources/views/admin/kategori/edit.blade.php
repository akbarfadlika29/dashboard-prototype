...
<div class="grid gap-5">
    ...
    <input name="nama" value="{{ $kategori->nama }}"
        class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 outline-none">

    <input name="slug" value="{{ $kategori->slug }}"
        class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 outline-none">

    <textarea name="deskripsi"
        class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 outline-none">{{ $kategori->deskripsi }}</textarea>
